...
def test_manage_treatment_record(hospital_management_T):
    hospital_management_T.manage_treatments("record","T001","P001","D001","Tiene Arritmia","11-12-2024")
    assert "T001" in hospital_management_T.treatments

def test_manage_treatment_update(hospital_management_T):
    hospital_management_T.manage_treatments("record","T001","P001","D001","Tiene Arritmia","11-03-2025")
...
def test_invalid_patient_dob():
    with pytest.raises(ValueError):
        Patient("P003", "Ravichagua", "16/022000") 
...
def test_invalid_doctor_specialitation():
    with pytest.raises(ValueError):
        Doctor("D001", "Bruce Banner", "???", ["10-11-2024, 11:00"])

def test_invalid_doctor_slot():
    with pytest.raises(ValueError):
        Doctor("D001", "Bruce Banner", "Oncología", ["10-11-2o2o, 11:00pm"])

def test_invalid_appointment_datetime():
    with pytest.raises(ValueError):
        Appointment("C001", "P001","D001", "10-11-2o24, 11:oo","scheduled")    
